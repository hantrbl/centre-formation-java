...
public class AjouterFormateurPanel extends JPanel {

    public AjouterFormateurPanel(CentreFormation centre) {
        ...
        JLabel headerLabel = new JLabel("Gestion des Formateurs");
        ...
        addFormRow(formPanel, gbc, 3, "Spécialité :", specialite);
        ...
        ajouterBtn.addActionListener(e -> {
            try {
                ...
                clearFields(id, nom, age, specialite);
        ...
        modifierBtn.addActionListener(e -> {
            try {
                ...
                if (idText.isEmpty()) {
                    JOptionPane.showMessageDialog(this, 
                        "Veuillez entrer l'ID du formateur à modifier", 
                        "Erreur", 
                        JOptionPane.ERROR_MESSAGE);
                    return;
                }
                
                centre.modifierFormateur(
                    idText,
                    nom.getText().trim(),
                    Integer.parseInt(age.getText().trim()),
                    specialite.getText().trim()
        ...
        supprimerBtn.addActionListener(e -> {
            ...
            if (idText.isEmpty()) {
                JOptionPane.showMessageDialog(this, 
                    "Veuillez entrer l'ID du formateur à supprimer", 
                    "Erreur", 
                    JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            int confirm = JOptionPane.showConfirmDialog(this,
                "Êtes-vous sûr de vouloir supprimer le formateur " + idText + " ?",
                "Confirmation",
